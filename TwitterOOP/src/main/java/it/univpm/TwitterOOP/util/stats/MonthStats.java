...
/**
 * Questa classe viene utilizzata per effettuare le statistiche
 * relative ai mesi dei tweet
 * 
...
public class MonthStats {
	...
	/**
	 * Calcola le statistiche mensili scorrendo l'arraylist di tweet, che conterrà solo i tweet relativi
	 * ad un determinato anno
	 * @param list
	 */
	...
	private void calculateStats(ArrayList<Tweet> list) {
		...
		//scorro l'arraylist contentente solo i mesi, e per ogni elemento creo un arraylist
		//che contiene i tweet relativi a quel mese e lo passo alla classe DailyStats per i relativi calcoli
		for(int i=0; i<months.size();i++) {
			...
			//passo l'array list contenente solo i tweet relativi ad un particolare mese a DailyStats per i calcoli
