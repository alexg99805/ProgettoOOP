 ...
 * passato ha una dimensione compresa tra due parametri
 * 
 * @see Tweet
 * @see IntegersCompare
 * @see Filter
 ...
 * @author Alex Giaccio
 */
public class FilterSizeIn extends IntegersCompare implements Filter {

	public FilterSizeIn(Object param) {
		super(param);
	}
