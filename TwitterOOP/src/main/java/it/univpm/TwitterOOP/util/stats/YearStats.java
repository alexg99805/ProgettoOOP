...
/**
 * classe che calcola le statistiche relative alle date dei tweet
 * prende l'arraylist completo dei tweet e ne estrapola i relativi anni
 * crea un arraylist di tweet che corrispondono ai diversi anni e li passa a MonthStats per i relativi calcoli
...
public class YearStats {
	...
	private void calculateStats(ArrayList<Tweet> list) {
		...
		//scorro l'arraylist contentente solo gli anni, e per ogni elemento creo un arraylist
		//che contiene i tweet relativi a quell'anno e lo passo alla classe MonthStats per i relativi calcoli
		for(int i=0; i<years.size();i++) {
			...
			//passo l'array list contenente solo i tweet relativi ad un particolare anno a MonthStats per i calcoli
