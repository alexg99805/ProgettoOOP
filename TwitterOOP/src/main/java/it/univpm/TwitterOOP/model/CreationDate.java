...
/**
 * Classe per effettuare il parsing delle date e mette in istruzione
 * i metodi per confrontare le date
...
public class CreationDate {
	...
	/**
	 * 
	 * metodo setter dell'attributo creation_date
	 * Viene effettuato anche il parsing del parametro formale
	 * @param date
	...
	public int compareTo(String dateToParse) {
		...
		if(this.creation_date.getDayOfMonth() == dateToCompare.getDayOfMonth() && this.creation_date.getMonthValue() == dateToCompare.getMonthValue() && this.creation_date.getYear() == dateToCompare.getYear())
		return 0;
		else if(this.creation_date.isBefore(dateToCompare)) return -1;
		return 1;
	}
